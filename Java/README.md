...
| **Avançado — Ecossistema** |  |  |
| Variáveis de ambiente e configuração | **Avançado** | 🔲 |
| Threads e Runnable | **Avançado** | 🔲 |
| Concorrência: synchronized, locks, volatile | **Avançado** | 🔲 |
| CompletableFuture e programação assíncrona | **Avançado** | 🔲 |
| Virtual Threads (Java 21, Project Loom) | **Avançado** | 🔲 |
| Gerenciamento de dependências com Maven / Gradle | **Avançado** | 🔲 |
| Estrutura de projetos Java | **Avançado** | 🔲 |
| Testes com JUnit 5 e Mockito | **Avançado** | 🔲 |
| Logging com SLF4J / Logback | **Avançado** | 🔲 |
| Profiling e performance (JMH, VisualVM) | **Avançado** | 🔲 |
| **Avançado — Como Java funciona** |  |  |
